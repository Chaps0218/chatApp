...
function UsersList({
  ...
  return (
    <div className="users-list">
                    ...
                    {users.map((user) => (
                      <li
                        ...
                        className={`available-user ${
                          selectedParticipants.includes(user.nickName)
                            ? "active"
                            : ""
                        }`}
      ...
      <div>
        <button className="boton-normal" onClick={openModal}>
          {" "}
          Crear grupo
        </button>
        <ModalCrearGrupo
        ...
        <a className="logout" href="#" onClick={salir}>
          Cerrar sesión
        </a>
      </div>
    </div>
